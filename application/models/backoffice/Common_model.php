                ...
                if($value->check_add_ons == 1){
                    ...
                    if($value->is_deal == 1){
                        if(!isset($menu[$value->category_id]['items'][$value->menu_id]['addons_category_list'])){
                           ...
                           //$menu[$value->category_id]['items'][$value->menu_id]['addons_category_list']['addons_category'] = $value->deal_category_name;
                           //$menu[$value->category_id]['items'][$value->menu_id]['addons_category_list']['addons_category_id'] = $value->deal_category_id;
