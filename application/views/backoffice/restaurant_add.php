...
$this->load->view(ADMIN_URL.'/header');?>
	...
	<div class="page-container">
		...
		if($this->input->post()){
			...
			$FieldsArray = array('content_id','entity_id','name','phone_number','email','capacity','no_of_table','no_of_hall','hall_capacity','address','landmark','latitude','longitude','state','country','city','zipcode','amount_type','amount','enable_hours','timings','image','is_veg','driver_commission','currency_id','restaurant_slug','created_by');
	...
	<script src="//maps.google.com/maps/api/js?key=AIzaSyCQZMTcIoNAglnGHxFJHNhQonydOqhsYJU" type="text/javascript"></script>
