    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu" data-auto-scroll="false" data-auto-speed="200">
           ...
           <li class="start <?php echo ($this->uri->segment(2) == 'report_template') ? "active" : ""; ?>">
                    ...
                    <ul class="sub-menu">
                        <li class="start <?php echo ($this->uri->segment(2) == 'report_template' && $this->uri->segment(3) != 'viewRiders' && $this->uri->segment(3) != 'viewDeliveredReport' && $this->uri->segment(3) != 'viewCancelReport' && $this->uri->segment(3) != 'viewResOrders' && $this->uri->segment(3) != 'viewUserAcquisition' && $this->uri->segment(3) != 'viewResItems' && $this->uri->segment(3) != 'viewUserItems' && $this->uri->segment(3) != 'viewTopUsers' && $this->uri->segment(3) != 'viewTopUsersOrderValueWise') ? "active" : ""; ?>">
                            <a href="<?php echo base_url() . ADMIN_URL; ?>/report_template/view">
                                <i class="fa fa-file-text"></i>
