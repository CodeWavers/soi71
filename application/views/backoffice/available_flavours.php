                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption">Available Flavours</div>
        ...
        callback: function (disableConfirm) {   
            if (disableConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "json",
                  url : 'ajaxDisable',
                  data : {'entity_id':ID,'status':Status,'tblname':'available_flavours'},
                  success: function(response) {
                       grid.getDataTable().fnDraw(); 
                  },
                  error: function(XMLHttpRequest, textStatus, errorThrown) {           
        ...
        callback: function (disableConfirm) {    
            if (disableConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "json",
                  url : 'ajaxDisableAll',
                  data : {'content_id':ContentID,'status':Status,'tblname':'add_ons_category'},
                  success: function(response) {
                    grid.getDataTable().fnDraw(); 
                  },
                  error: function(XMLHttpRequest, textStatus, errorThrown) {           
