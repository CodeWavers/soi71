...
if($this->input->post()){
  ...
  $FieldsArray = array('entity_id','name');
...
{
    $add_label    = $this->lang->line('edit').' Available Flavours';        
...
{
    $add_label    = $this->lang->line('add').' Available Flavours';        
        ...
        <div class="page-content">            
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">Available Flavours</h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name?>/view">Available Flavours</a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <?php echo $add_label;?> 
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add_<?php echo $this->prefix ?>" name="form_add_<?php echo $this->prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                <div class="form-body">                                     
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Flavour Name<span class="required">*</span></label>
                                        <div class="col-md-4">
