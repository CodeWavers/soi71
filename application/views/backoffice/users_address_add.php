        ...
        <div class="page-content">            
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title"><?php echo $this->lang->line('user_address') ?></h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name?>/view"><?php echo $this->lang->line('user') ?></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <?php echo $add_label;?> 
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add<?php echo $this->ad_prefix ?>" name="form_add<?php echo $this->ad_prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a class="btn btn-danger danger-btn" href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/view/user_address"><?php echo $this->lang->line('cancel')?></a>
                                    </div>
                                </div>
                            </form>
                            <!-- END FORM-->
