...
<div class="pdf_main">
	...
	<table border="3" cellpadding="10" cellspacing="0" width="100%" class="table-style">
		...
		<tr>
			...
			<td class="align-left"><?php echo ($order_records->coupon_amount) ? (($order_records->coupon_type == 'Amount') ? '(-)' . $restaurant_detail->currency_symbol : '') . number_format_unchanged_precision($order_records->coupon_amount, $restaurant_detail->currency_code) : '(-)'; ?><?php echo ($order_records->coupon_type == 'Percentage') ? '% ( ' . number_format_unchanged_precision(round(($order_records->coupon_amount * $order_records->subtotal) / 100)) . ')' : '' ?></td>
		</tr>
		<tr>
