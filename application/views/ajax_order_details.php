                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong><?php echo $order_details[0]['currency_symbol']; ?> <?php echo number_format($order_details[0]['service_charge'], 2);; ?></strong></td>
                        </tr>
                        <tr>
                            <td><?php echo "Vat" ?></td>
                            <td><strong><?php echo $order_details[0]['currency_symbol']; ?> <?php echo number_format($order_details[0]['vat'], 2);; ?></strong></td>
                        </tr>
