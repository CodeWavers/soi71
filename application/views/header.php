...
<div class="manu-icon" >
	...
	<ul>
		...
		<li class="<?php echo ($current_page == 'RestaurantDetails') ? 'current' : ''?>">
			<a href="<?php echo base_url('restaurant/restaurant-detail/'.$slug);?>">
				<img src="<?php echo base_url();?>uploads/m.jpg"  style="width:0.99rem"> </a>
			<span>Menu</span>
		</li>
