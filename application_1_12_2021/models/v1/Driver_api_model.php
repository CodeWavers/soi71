...
class Driver_api_model extends CI_Model {
    ...
    public function getallOrder($user_id){
        ...
        //current
        $this->db->select('order_detail.restaurant_detail,order_detail.order_id,order_detail.item_detail,order_driver_map.driver_map_id,order_master.order_status,order_master.total_rate,order_master.subtotal,order_master.created_date,order_detail.user_detail,users.mobile_number,users.image,restaurant_address.latitude,restaurant_address.longitude,currencies.currency_symbol,currencies.currency_code,order_master.transaction_id,order_master.vat,order_master.sd,order_master.delivery_charge');
