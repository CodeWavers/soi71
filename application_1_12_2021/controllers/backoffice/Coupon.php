...
class Coupon extends CI_Controller { 
    	...
    	if($this->input->post('submit_page') == "Submit")
        {
            ...
            {  
                $add_data = array(  
                    ...
                    // 'gradual_all_items' => $this->input->post('gradual_all_items')
                );  
    ...
    public function edit(){
        ...
        $data['restaurant'] =  $this->coupon_model->getListData('restaurant',array('status'=>1));//$this->coupon_model->restaurantMap($entity_id);//
        ...
        $data['type'] = 'edit';
        //$data['user_map'] = $this->coupon_model->getListData('coupon_user_map',array('coupon_id'=>$entity_id));
        //$data['user'] = $this->coupon_model->getListData('users',array('status'=>1, 'user_type' => 'User'));
        $this->load->view(ADMIN_URL.'/coupon_add',$data);
    }
