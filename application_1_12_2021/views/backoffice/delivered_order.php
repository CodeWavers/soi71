        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php  echo $this->lang->line('delivered').' '.$this->lang->line('order') ?> <?php echo $this->lang->line('list') ?>
                    </h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <?php  echo $this->lang->line('delivered').' '.$this->lang->line('order') ?>
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"> <?php  echo $this->lang->line('delivered').' '.$this->lang->line('order') ?> <?php echo $this->lang->line('list') ?></div>
                            <div class="actions">
    ...
    grid.init({
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
           ...
           "aoColumns": [
            ...
            "sAjaxSource": "ajaxview/delivered", // ajax source
