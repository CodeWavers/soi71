        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php  echo $this->lang->line('onGoing').' '.$this->lang->line('order') ?> <?php echo $this->lang->line('list') ?>
                    </h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <?php echo $this->lang->line('onGoing').' '.$this->lang->line('order') ?>
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php  echo $this->lang->line('onGoing').' '.$this->lang->line('order') ?> <?php echo $this->lang->line('list') ?></div>
                            <div class="actions">
...
<div class="wait-loader display-no" id="quotes-main-loader dialog-no display-no"><img  src="<?php echo base_url() ?>assets/admin/img/ajax-loader.gif" align="absmiddle"  ></div>
