...
if($this->input->post()){
  ...
  $FieldsArray = array('content_id','entity_id','name','phone_number','email','capacity','no_of_table','no_of_hall','hall_capacity','address','landmark','latitude','longitude','state','country','city','zipcode','amount_type','amount','enable_hours','timings','image','is_veg','driver_commission','currency_id','restaurant_slug');
            ...
            <div class="modal-body">                                               
                <form class="form-inline margin-bottom-10" action="#">
                    <div class="input-group">
                        <input type="text" class="form-control" id="gmap_geocoding_address" placeholder="<?php echo $this->lang->line('place_address') ?>">
