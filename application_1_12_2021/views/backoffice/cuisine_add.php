...
if($this->input->post()){
  ...
  $FieldsArray = array('entity_id','name','cover_image','defination');
...
{
    $add_label    = $this->lang->line('edit').' Cuisine';        
    ...
    $category_map = array_column($category_map, 'category_id');
}
else
{
    $add_label    = $this->lang->line('add').' Cuisine';        
        ...
        <div class="page-content">            
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">Cuisine</h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name?>/view">Cuisine</a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <?php echo $add_label;?> 
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add_<?php echo $this->prefix ?>" name="form_add_<?php echo $this->prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                <div class="form-body">                                     
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Cuisine Name<span class="required">*</span></label>
                                        <div class="col-md-4">
                                                ...
                                                <select name="category_id[]" multiple="" class="form-control" id="category_id">
                                                    <?php if (!empty($allCategory)) {
                                                        foreach ($allCategory as $key => $value) { ?>
                                                            <option value="<?php echo $value->entity_id ?>" <?php echo in_array($value->entity_id, $category_map) ? 'selected' : '' ?>><?php echo $value->name ?></option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Defination<span class="required">*</span></label>
                                        <div class="col-md-8">
                                            <input type="text" name="defination" id="defination" value="<?php echo $defination; ?>" maxlength="249" data-required="1" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="uploaded_image" id="uploaded_image" value="<?php echo isset($cover_image)?$cover_image:''; ?>" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <?php if(isset($cover_image) && $cover_image != '') {?>
                                                    <span class="block"><?php echo $this->lang->line('selected_image') ?></span>
                                                            <img id='oldpic' class="img-responsive" src="<?php echo base_url().'uploads/'.$cover_image;?>">
                                            <?php }  ?>
                                        </div>
                                    </div>                                    
                                </div>
