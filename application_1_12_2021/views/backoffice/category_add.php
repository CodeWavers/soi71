...
if(isset($edit_records) && $edit_records !="")
{
    ...
    $cuisine_map = array_column($cuisine_map, 'cuisine_id');
}
else
{
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add_<?php echo $this->prefix ?>" name="form_add_<?php echo $this->prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                <div class="form-body">                                     
                                    ...
                                    <div class="form-group">
                                            <label class="control-label col-md-3">Cuisine</label>
                                            <div class="col-md-8">
                                                <select name="cuisine_id[]" multiple="" class="form-control" id="cuisine_id">
                                                    <?php if (!empty($allCuisine)) {
                                                        foreach ($allCuisine as $key => $value) { ?>
                                                            <option value="<?php echo $value->entity_id ?>" <?php echo in_array($value->entity_id, $cuisine_map) ? 'selected' : '' ?>><?php echo $value->name ?></option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </div>
