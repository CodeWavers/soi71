                 ...
                 <br>
                      ...
                      <table id="orderList" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                         ...
                         <tfoot align="right">
                            <tr><th class="text-right"></th><th></th><th></th><th></th><th></th><th></th><th></th></tr>
                          </tfoot>
                      </table>
...
$(document).ready(function(){
            ...
            buttons:[ {
                    ...
                    }, title: "RestaurantOrderList", className: "btn-md prints"
                }
            ...
            'columns':[
                ...
                {data:'restaurant_payable','width': '10%',orderable:false},
      ...
      $( api.column( 0 ).footer() ).html('Total');
           ...
           // $( api.column( 5 ).footer() ).html(totalEarn);
            ...
            $( api.column( 6 ).footer() ).html(handTotal.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}));
        },
        });
