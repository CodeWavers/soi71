                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">Delivery Area</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                    <thead>
                                        ...
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control form-filter input-sm" name="delivery_charge"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="rider_commision"></td>
                                            <td>
...
<script>
    ...
    function disableDetail(ID, Status) {
