        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php echo ' Customized ' . $this->lang->line('order') ?> <?php echo $this->lang->line('list') ?>
                    </h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <?php echo ' Customized ' . $this->lang->line('order') ?>
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo ' Customized ' . $this->lang->line('order') ?> <?php echo $this->lang->line('list') ?></div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <div id="scrollss" style="overflow: auto;">
    ...
    jQuery(document).ready(function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "sAjaxSource": "getCustomizedItems", // ajax source
                "aaSorting": [
                    [7, "desc"]
