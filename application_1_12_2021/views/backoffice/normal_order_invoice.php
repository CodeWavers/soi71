...
<div class="pdf_main">
			...
			if (!empty($item_detail)) {
				...
				foreach ($item_detail as $key => $value) {
					...
					<div class="b0">
						...
						<div class="div_2"><?php echo $value['note']; ?></div>
						...
						<div class="center div_5"><?php echo $restaurant_detail->currency_symbol; ?><?php echo ($Subtotal) ? number_format_unchanged_precision($Subtotal * $value['qty_no'], $restaurant_detail->currency_code) : number_format_unchanged_precision($price * $value['qty_no'], $restaurant_detail->currency_code);
																									$Subtotal = 0;
																									$addons_name_list = '';
																									$i = $i + 1;
																									?></div>
	...
	<table border="3" cellpadding="10" cellspacing="0" width="100%" class="table-style">
		<tr>
			<td rowspan="6" class="width60">
				<?php echo ($order_records->extra_comment) ? 'Preferences: ' . $order_records->extra_comment : '' ?>
				<br></br>
				<?php echo ($user_detail['note']) ?>
			</td>
