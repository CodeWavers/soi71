		...
		<div class="bill-ship-details">
			<div class="colm fleft">
				...
				if (!empty($user_detail)) { ?>
					<p><?php echo $user_detail['first_name'] . ' ' . $user_detail['last_name'] . '<br>' . $order_records->mobile_number . '<br>' . $user_detail['address'] . '<br> ' . $user_detail['landmark'] . '<br>' . $user_detail['city'] . ' ' . $user_detail['zipcode'] . '<br>' . $pay ?></p>
				<?php } else { ?>
	...
	<div class="segment-main">
		...
		<div class="div-thead">
			<div>
				...
				<div class="div_4">Size</div>
				<div class="div_4">User Description</div>
                <div class="div_4">Admin Description</div>
		...
		<div>
			...
			if (!empty($item_detail)) {
				...
				foreach ($item_detail as $key => $value) {
					$price = ($value['offer_price']) ? $value['offer_price'] : $value['price']; ?>
					<div class="b0">
						<div class="div_1"><?php echo $i ?></div>
						<div class="div_2"><?php echo $value['flavour']; ?></div>
						<div class="center div_3"><?php echo $value['size'] ?></div>
						<div class="center div_4"><?php echo $value['description'] ?></div>
                        <div class="center div_4">  <?php echo $value['admin_description'] ?></div>
						<div class="center div_5"><?php echo $restaurant_detail->currency_symbol; ?><?php echo number_format_unchanged_precision($price, $restaurant_detail->currency_code);
