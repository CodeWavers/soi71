...
if($this->input->post()){
  ...
  $FieldsArray = array('entity_id','name', 'address','status');
...
{
    $add_label    = $this->lang->line('edit').' Outlet ';        
...
{
    $add_label    = $this->lang->line('add').' Outlet';        
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name?>/view">Outlet</a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <?php echo $add_label;?> 
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add_<?php echo $this->prefix ?>" name="form_add_<?php echo $this->prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                <div class="form-body">                                     
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Outlet Name<span class="required">*</span></label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="address" id="address" value="<?php echo $address;?>" maxlength="500" data-required="1" class="form-control"/>
                                        </div>
                                    </div>
