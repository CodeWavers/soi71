...
<![endif]-->
<script src="https://kit.fontawesome.com/028e60a566.js" crossorigin="anonymous"></script>
    ...
    <div class="page-header-inner">
        ...
        <div class="top-menu">
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li>
                    <?php $custom_noti_count = $this->common_model->getCustomNotificationCount(); ?>
                    <div class="notification">
                        <a href="<?php echo base_url().ADMIN_URL ?>/order/customize_items" onclick="changeCustomViewStatus();"><span><i class="fa fa-birthday-cake" aria-hidden="true"></i><span class="custom_count"><?php echo (!empty($custom_noti_count))?($custom_noti_count->order_count >= 100)?'99+':$custom_noti_count->order_count:'0' ?></span></span></a>
                    </div>
                </li>
            ...
            <ul class="nav navbar-nav pull-right language-change">                                
                    ...
                    {?>      
                        <li onclick="setLanguage('<?php echo $language->language_slug ?>')"><i class="glyphicon bfh-flag-<?php echo $language->language_slug ?>"></i><?php echo $language->language_name; ?></li>
                    <?php }
                    ?>
            </ul>
        </div>
