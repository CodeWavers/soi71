                      ...
                      <br>                    
                                                    ...
                                                    <!-- <div class="table-responsive"> -->
                                                        <table id="allOrderList" class="table table-striped table-bordered" >
                                                            ...
                                                            <tfoot align="right">
                                                              <tr>
                                                                <th class="text-right"></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th>
                                                              </tr>
                                                            </tfoot>
...
$(document).ready(function(){
            ...
            buttons:[ {
                    ...
                    }, title: "Customer_Order_List", className: "btn-md prints"
                }
      ...
      $( api.column( 0 ).footer() ).html('Total');
            ...
            $( api.column( 9 ).footer() ).html(totalPay.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}));
        },
